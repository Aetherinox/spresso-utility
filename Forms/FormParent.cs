            ...
            */
            ...
            private void btn_Copy_Click( object sender, EventArgs e )
            {
                ...
                if (string.IsNullOrEmpty( txt_LicenseKey.Value ) )
                {
                    ...
                    status_Label.Text = string.Format( Lng.statusbar_copy_invlicense );
                    statusStrip.Refresh( );
                }
                else
                {
                    ...
                    status_Label.Text = string.Format( Lng.statusbar_copy_success );
                    statusStrip.Refresh();
                }
            }
